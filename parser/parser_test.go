...
func TestInegerLiteralExpressions(t *testing.T) {
	input := `5;`
...
func testIntegerLiteral(t *testing.T, il ast.Expression, value int64) bool {
	...
	if !ok {
		t.Errorf("integ not *ast.IntegerLiteral. got=%T", integ)
		return false
	}
...
func TestBooleanLiteral(t *testing.T) {
	...
	for _, tt := range tests {
		...
		if boolean.Value != tt.value {
			t.Errorf("boolean.Value not %t. got=%t", tt.value, boolean.Value)
		}
	}
}
...
func TestIfExpressions(t *testing.T) {
	...
	if !ok {
		t.Errorf("stmt.Expression not *ast.IfExpression. got=%T", stmt.Expression)
	}
	...
	if len(exp.Consequence.Statements) != 1 {
		t.Fatalf("exp.Consequence.Statements does not contain 1 statements. got=%d", len(exp.Consequence.Statements))
	}
...
func TestIfElseExpressions(t *testing.T) {
	...
	if len(exp.Alternative.Statements) != 1 {
		t.Fatalf("exp.Alternative.Statements does not contain 1 statements. got=%d", len(exp.Alternative.Statements))
	}
...
func TestParseFunctionLiteral(t *testing.T) {
	...
	if len(function.Parameters) != 2 {
		t.Errorf("function.Parameters does not contain 2 parameters. got=%d", len(function.Parameters))
	}
	...
	if !ok {
		t.Errorf("function.Body.Statements[0] not *ast.ExpressionStatement. got=%T", function.Body.Statements[0])
	}
...
func TestParseFunctionParameters(t *testing.T) {
	...
	for _, tt := range tests {
		...
		if len(function.Parameters) != len(tt.expected) {
			t.Errorf("function.Parameters does not contain %d parameters. got=%d", len(tt.expected), len(function.Parameters))
		}
...
func TestCallExpressionsParsing(t *testing.T) {
	input := "add(1, 2 * 3, 4 + 5);"
	...
	if len(exp.Arguments) != 3 {
		t.Errorf("exp.Arguments does not contain 3 arguments. got=%d", len(exp.Arguments))
	}
